...
public class RequestPackage {
    ...
    public RequestPackage(InputStream inputStream) {
        this();
     ...
     * @return
     */
    public RequestPackage parseRequestInfo(InputStream inputStream) {
        ...
        String requestPackageString = new String(datas, 0, length);
